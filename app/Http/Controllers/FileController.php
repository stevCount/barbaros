...
class FileController extends Controller
{
    ...
    public function store(Request $request)
    {
         ...
         */
        Storage::disk('dropbox')->putFileAs('/new', 
            $request->file('file'), 
        ...
        $response = $this->dropbox->createSharedLinkWithSettings("new/$imageName", 
        ...
        File::create([
            ...
            'size' => $response['size'],
            'public_url' => str_replace('dl=0','raw=1',$response['url'])
        ]);
    ...
    public function download(File $file)
    {
         ...
         */
        return Storage::disk('dropbox')->download("new/$file->name");
    }
